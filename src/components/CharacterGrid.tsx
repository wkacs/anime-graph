...
export default function CharacterGrid({ anilistId, animeId }: { anilistId: number; animeId: number }) {
  ...
  return (
    <section className="glass rounded-3xl p-5">
      <p className="label-mono mb-3">Szereplők <span className="text-text-3">— ♥ a kedvenceid a gráfba kerülnek</span></p>
